...
/**
 * ChannelNumberDisplay — floating badge in the top-right that shows the
 * digits the user has typed via the remote. The LG system keyboard path was
 * removed once a custom on-screen ChannelNumberPad was added; this
 * component is now a pure presentational badge.
 */
