...
export const API_ENDPOINTS = {
  ...
  OTT_LOGS: `${API_BASE_URL_PROD}/ottlogs`,
  OTT_SCREEN_BGS: `${API_BASE_URL_PROD}/ottscreenbgs`,
  APP_VERSION: `${API_BASE_URL_PROD}/appversion`,
  ERROR_IMAGES: `${API_BASE_URL_PROD}/errorimages`,
  LOGO: `${API_BASE_URL_PROD}/fofitv_logo`,
  PRIMARY_CUST_DET: `${API_BASE_URL_PROD}/primarycustdet`,
  UPDATE_MOB_NUM: `${API_BASE_URL_PROD}/updateMobNum`,
  ADD_USERS: `${API_BASE_URL_PROD}/addusers`,
  STREAM: `${API_BASE_URL_PROD}/stream`,
  SSO_LOGIN: `${API_BASE_URL_PROD}/ssologin`,
  GET_DEVICE_ID: `${API_BASE_URL_PROD}/getdeviceid`,
  DEV_AUTH: `${API_BASE_URL_PROD}/devAuth`,
  OYO_CHNL_VIDEO: `${API_BASE_URL_PROD}/oyo_chnl_video`,
  OYO_MEDIA_CATEGS: `${API_BASE_URL_PROD}/oyo_mediacategs`,
  OYO_MEDIA: `${API_BASE_URL_PROD}/oyo_media`,
  OYO_ADS: `${API_BASE_URL_PROD}/oyoads`,
};
